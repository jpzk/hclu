...
# \file single_linkage_ehac.py
# \brief Single Linkage with EfficentHAC algorithm, 
...
#
class SingleLinkageEfficientHAC(Strategy):
    """Single Linkage with EfficientHAC algorithm"""

    description = "Single Linkage with Efficient HAC algorithm"
    ...
    def initialize(self, data):
        ...
        super(SingleLinkageEfficientHAC, self).initialize(data)
