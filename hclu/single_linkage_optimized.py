...
# \brief Optimized naive Single Linkage Implementation.
# \author Bjoern Borgmann <bjoern.borgmann@uni-oldenburg.de>
class SingleLinkageOptimized(Strategy):
    '''
    Optimized naive Single Linkage Implementation
    '''
    
    #Strategy Description
    description = "Optimized naive Single Linkage Implementation"
    ...
    def initialize(self, data):
        ...
        super(SingleLinkageOptimized, self).initialize(data)
